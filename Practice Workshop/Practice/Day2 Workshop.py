...
# 10. Retrieve all movies produced by Walt Disney Studios. You should display the Producer Name,
# Location, Movie Title and Movie Type. (Note: The first two fields are from Producer.JSON and
# the other two fields are from Movies.CSV. The join field is ProcuderCode field. If you have
# issues, you may change ProducerID column in the CSV to same as in JSON, viz. ProducerCode)
